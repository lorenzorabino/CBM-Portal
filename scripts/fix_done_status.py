...
def main():
    ...
    with app.app_context():
        with db.engine.begin() as conn:
            ...
            if not planner_id:
                p = conn.execute(text("SELECT id FROM Planner ORDER BY id DESC LIMIT 1")).fetchone()
